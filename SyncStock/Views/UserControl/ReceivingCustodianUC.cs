        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var confirmationPayload = new ConfirmedItems
                {
                    ...
                    IsCapitalizable = chckboxAsset.Checked,         // True = asset nga kailangan i-tag.
                    ...
                    AttachmentData = _uploadedFileBytes,            // Binary data sa proof-of-delivery.
                    AttachmentFileName = _uploadedFileName
                };

                // I-save na ang confirmation record.
                _repo.AddConfirmedItem(confirmationPayload);

                // I-abante ang PO line-item pinaagi sa workflow state machine.
