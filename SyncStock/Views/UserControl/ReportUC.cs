...
namespace SyncStock.Views.UserControl
{
    public partial class ReportUC : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        {
            XtraMessageBox.Show(
                "Print report feature is temporarily unavailable.",
                "Information",
        ...
        private void FilterBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (FilterBox.Text)
            {
                ...
                case "Received Orders":
                    XtraMessageBox.Show(
                        "Received Orders report is temporarily unavailable.",
                        "Information",
                        MessageBoxButtons.OK,
                        MessageBoxIcon.Information);
                    break;
                ...
                case "Capitalized Orders":
                    XtraMessageBox.Show(
                        "Capitalized Orders report is temporarily unavailable.",
                        "Information",
                        MessageBoxButtons.OK,
                        MessageBoxIcon.Information);
                    break;
                ...
                case "Reconciliation":
                    XtraMessageBox.Show(
                        "Reconciliation report is temporarily unavailable.",
                        "Information",
                        MessageBoxButtons.OK,
                        MessageBoxIcon.Information);
                    break;
